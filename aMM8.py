...
# Starten Sie den Event-Loop mit asyncio
  ...
  # Dummy-Daten initialisieren
    ...
    for i in range(80):
        ...
        if new_value < 59 or new_value > 81:
            loop.run_until_complete(show_popup_message())
        
        # Beispiel für pydeck-Chart
    # Hier können Sie auch Ihr pydeck-Visualisierungscode einfügen
        deck = pdk.Deck(
