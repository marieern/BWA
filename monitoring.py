...
y_data = simulate_soil_moisture(initial_moisture, simulation_days, precipitation_rate, evaporation_rate)
...
for i in range(80):
    ...
    new_x = x_data[-1] + 0.1
    new_y = simulate_soil_moisture(initial_moisture, simulation_days, precipitation_rate, evaporation_rate)
