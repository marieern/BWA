...
async def popup_message():
    ...
    elif not st.session_state.shared_state["selectbox_shown"] and st.session_state.shared_state["main_aufruf"]:
        with st.sidebar:
            st.write("Willkommen!")
    else:
    ...
    try:
        ...
        while st.session_state.i < 88:
            ...
            if selected_option == "JA":
                ...
                st.session_state.dfSoilMoisture, st.session_state.new_dfIrrigation = update_bwPlan(st.session_state.dataEditor, st.session_state.dfIrrigation, len(st.session_state.dfMonitor))

                #st.session_state.dfSoilMoisture, st.session_state.new_dfIrrigation = create_new_bwPlan()
