...
def popupmsg():
    ...
    # Button im Container platzieren
    button_clicked = popup_container.button("Klicken Sie hier, um fortzufahren")

    # Popup-Inhalt basierend auf dem Button-Klick aktualisieren
    if button_clicked:
        popup_container.success("Sie haben auf den Button geklickt! Aktion durchgeführt.")
...
def plost_soil_moisture(dfSoilMoisture, dfIrrigation):
  ...
  # Dummy-Daten initialisieren
    ...
    # Liste von Optionen für die Selectbox
    options = ["JA", "NEIN"]
