...
def plot_moisture_simulation(days, moisture_values):
    plt.plot(range(days + 1), moisture_values, marker='o')
    plt.title('Bodenfeuchte-Simulation')
    plt.xlabel('Tage')
    plt.ylabel('Bodenfeuchte')
    plt.grid(True)
    plt.show()
